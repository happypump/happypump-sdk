...
import { HappyPump, IDL } from "./IDL/index.js";
...
export class HappyPumpSDK {
    public program: Program<HappyPump>;
    public connection: Connection;
    
    constructor(provider?: Provider) {
        this.program = new Program<HappyPump>(IDL as HappyPump, provider);
    ...
    async getBuyInstructionsBySolAmount(
        ...
        console.log(`buyAmountSol: ${buyAmountSol}, buyAmount: ${buyAmount}, buyAmountWithSlippage: ${buyAmountWithSlippage}`);
