...
The `HappyPumpSDK` is designed to interact with the HappyPump.io decentralized application. It provides methods for creating, buying, and selling tokens using the Solana blockchain. The SDK handles the necessary transactions and interactions with the HappyPump.io program.
...
import { DEFAULT_DECIMALS, HappyPumpSDK } from "happypump-sdk";
...
The `HappyPumpSDK` class provides methods to interact with the HappyPump protocol. Below are the method signatures and their descriptions.
...
This example demonstrates how to set up event subscriptions using the HappyPump SDK.
...
import { HappyPumpSDK } from "happypump-sdk";
import NodeWallet from "@coral-xyz/anchor/dist/cjs/nodewallet";
import { AnchorProvider } from "@coral-xyz/anchor";
...
By following this README, you should be able to install the HappyPump SDK, run the provided examples, and understand how to set up event listeners and perform token operations.